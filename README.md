...
- **Uninformed Search**: Breadth First Search, Depth First Search, Depth-limited Search, Uniform Cost Search (Dijkstra's algorithm)
- **Informed Search** Greedy Best First Search, A* Search

The code is written in Python 3.7 and has been tested on Ubuntu 18.04/20.04. As the first step, clone this repository with:

```sh
$ git clone https://github.com/geraldfw/Perlen2-CommonRoad-Search.git
```
...
If you encountered any problem, please raise it in the [CommonRoad Forum](https://commonroad.in.tum.de/forum/) so that other users can also benefit from the answers to your questions.
